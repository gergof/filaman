...
import AddSpoolTemplate from './AddSpoolTemplate/AddSpoolTemplate';
import EditMaterial from './EditMaterial/EditMaterial';
import EditPrint from './EditPrint/EditPrint';
import EditPrinter from './EditPrinter/EditPrinter';
import EditSpool from './EditSpool/EditSpool';
import EditSpoolTemplate from './EditSpoolTemplate/EditSpoolTemplate';
...
export const EditPrintScreen = EditPrint;
